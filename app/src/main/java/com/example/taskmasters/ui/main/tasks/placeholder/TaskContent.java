package com.example.taskmasters.ui.main.tasks.placeholder;
...
public class TaskContent {
    ...
    public static void loadTasksFromDatabase(Context context, PlaceholderCallback callback) {
        ...
        TaskDAO.TaskListCallback taskListCallback = new TaskDAO.TaskListCallback() {
            @Override
            ...
            @Override
            public void onTaskListError(DatabaseError databaseError) {
